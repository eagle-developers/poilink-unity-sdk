...
typedef void (*PoilinkRewardReceiveCallback)(const char* grantId, const char* itemCode, int quantity, const char* missionCode);
...
typedef void (*PoilinkRewardsReceiveCallback)(const PoilinkRewardGrant* grants, int count);
...
typedef struct {
    ...
    PoilinkRewardsReceiveCallback onRewardsReceive;
} WebPortalOptions;
