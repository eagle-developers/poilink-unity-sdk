...
#pragma warning restore IDE0051
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void RewardReceiveCallbackNative(IntPtr grantIdPtr, IntPtr itemCodePtr, int quantity);
        ...
        private static void OnShowWebPortalRewardReceive(IntPtr grantIdPtr, IntPtr itemCodePtr, int quantity)
        {
            ...
            if (callback != null)
            {
                UnityMainThreadDispatcher.Enqueue(() =>
                {
                    callback(grantId, itemCode, quantity);
